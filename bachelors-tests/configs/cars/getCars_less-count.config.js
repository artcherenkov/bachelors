...
const classHelper = (faker) => faker.vehicle.type();
...
const makeHelper = (faker) => faker.vehicle.manufacturer();
const modelHelper = (faker) => faker.vehicle.model();
...
const driveHelper = (faker) => faker.helpers.arrayElement(["2wd", "4wd"]);
...
const imageHelper = (faker) => faker.helpers.arrayElement(arr);
